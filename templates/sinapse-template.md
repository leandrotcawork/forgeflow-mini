...
Use headings, code blocks, examples. All standard Markdown supported.

```go
// Code example
func ExampleFunction() string {
    return "ForgeFlow Mini sinapses are standard Markdown"
}
```
...
**Created:** 2026-03-24 | **Updated:** 2026-03-24 | **Weight:** 0.5
